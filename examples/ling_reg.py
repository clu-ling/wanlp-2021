...
class DA(object):
    ...
    def make_model(self):
        ...
        embeddings_c2 = Embedding(max_features, 3, embeddings_initializer="uniform",
        ...
        ling_regularizer = tf.Variable(tf.random.uniform([flat_c2.shape[-1]], minval=0, maxval=None,
                              dtype=tf.dtypes.float32, seed=None, name="ling-regularizer"), trainable=True
